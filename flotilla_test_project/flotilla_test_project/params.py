...
mapping_stats_data_dump = None
#mapping_stats_data_dump = os.path.join(study_data_dir, 'mapping_stats.tsv')

ercc_metadata_filename = None
#ercc_metadata_filename = os.path.join(study_data_dir, 'ERCC_Controls_Analysis.txt')
