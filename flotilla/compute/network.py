...
class Networker(object):
    ...
    @memoize
    def adjacency(self, data=None, use_pc_1=True, use_pc_2=True,
    ...
    def graph(self, adjacency=None, cov_cut=None, name=None,
        ...
        for node_label in adjacency.index:
            ...
            g.add_node(node_label, node_size=node_size,
        ...
        for cell1, others in adjacency.iterrows():
            for cell2, value in others.iteritems():
                if value > cov_cut:
                    ...
                    g.add_edge(cell1, cell2, weight=float(wt(value)),
                               inv_weight=float(1 / wt(value)), alpha=0.05)

        g.remove_nodes_from(
            [k for k, v in g.degree().iteritems() if v <= degree_cut])
