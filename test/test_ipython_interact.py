...
lists = [
    'https://www.dropbox.com/s/qddybszcses6pi6/DE_genes.male%20adult%20%2019.txt?dl=0']

# Begin IPython core code
...
def test_list_tuple_3_int():
    ...
    for min, max, step in [(0, 2, 1), (1, 10, 2), (1, 100, 2), (-5, 5, 4),
                           (-100, -20, 4)]:
...
# End IPython core code


class TestIPythonInteract(object):
    def test_interactive_pca(self, study):
        i = study.interactive_pca()


        # def test_interactive_graph(self, study):
        #     study.interactive_graph()
        #
        #
        # def test_interactive_classifier(self, study):
