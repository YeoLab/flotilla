...
class TestStudy(object):
    ...
    def test_from_datapackage(self, datapackage, datapackage_dir):
        ...
        metadata_resource = name_to_resource(datapackage, 'metadata')
        expression_resource = name_to_resource(datapackage,
                                                     'expression')
        splicing_resource = name_to_resource(datapackage, 'splicing')
