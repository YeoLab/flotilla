...
class TestStudy(object):
    ...
    def test_tidy_splicing_with_expression(self, study, monkeypatch,
        ...
        # splicing_tidy.set_index([study._sample_id, study._common_id],
        #                         inplace=True)
        # expression_tidy.set_index([study._sample_id, study._common_id],
        #                           inplace=True)
