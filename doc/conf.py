...
# sphinx-quickstart on Thu Jul 10 08:32:34 2014.
#
...
project = u'flotilla'
copyright = u'2014, Olga B. Botvinnik, Michael T. Lovci, Patrick Liu, ' \
            u'Yan Song, and Gene Yeo'
...
html_theme_options = {
    ...
    'bootswatch_theme': "sandstone",  # "united",
...
latex_documents = [
    ('index', 'flotilla.tex', u'flotilla Documentation',
     u'Olga B. Botvinnik, Michael T. Lovci', 'manual'),
]
...
man_pages = [
    ('index', 'flotilla', u'flotilla Documentation',
     [u'Olga B. Botvinnik, Michael T. Lovci'], 1)
]
...
texinfo_documents = [
    ('index', 'flotilla', u'flotilla Documentation',
     u'Olga B. Botvinnik, Michael T. Lovci', 'flotilla',
